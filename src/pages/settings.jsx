...
export function SettingsPage() {
  ...
  const handleResetDatabase = async () => {
    ...
    try {
      ...
      console.log("Attempting to fetch:", apiUrl) // Debug log
              ...
              <div className="grid gap-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Administrative controls for system data</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="flex items-center justify-between">
                      <div className="space-y-1">
                        <Label>Reset Database</Label>
                        <p className="text-sm text-muted-foreground">Reset all system data to default state</p>
                      </div>
                      <Button 
                        variant="destructive" 
